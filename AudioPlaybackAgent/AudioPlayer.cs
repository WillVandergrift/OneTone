...
namespace AudioPlaybackAgent
{
    public class AudioPlayer : AudioPlayerAgent
    {
        ...
        /// </summary>
        public void Play(BackgroundAudioPlayer player)
        {
            player.Play();
        }
        ...
        /// </summary>
        public void Pause(BackgroundAudioPlayer player)
        {
            player.Pause();
        }

        /// <summary>
        /// Toggle the media players play state
        /// </summary>
        public void Toggle(BackgroundAudioPlayer player)
        {
            if (player.PlayerState == PlayState.Playing)
            {
                player.Pause();
        ...
        public void OpenFile(BackgroundAudioPlayer player, string file)
        {
            player.Track = new AudioTrack(new Uri(file, UriKind.Relative), file, "OneTone", "OneTone", null);
